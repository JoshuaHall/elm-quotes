...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {Q: fragment, T: host, X: path, Z: port_, ab: protocol, ac: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{as: false, au: r.au, ay: r.ay, R: r.R, aD: r.aD, aO: r.aO, am: r.am, aR: r.aR}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{au: $elm$http$Http$emptyBody, ay: r.ay, R: _List_Nil, aD: 'GET', aO: $elm$core$Maybe$Nothing, am: $elm$core$Maybe$Nothing, aR: r.aR});
};
var $author$project$Main$Quote = F2(
	function (quote, author) {
		return {L: author, ad: quote};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$quoteDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Quote,
	A2($elm$json$Json$Decode$field, 'content', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'author', $elm$json$Json$Decode$string));
var $author$project$Main$quotesApiUrl = 'https://api.quotable.io/random';
var $author$project$Main$getRandomQuote = $elm$http$Http$get(
	{
		ay: A2($elm$http$Http$expectJson, $author$project$Main$GotQuote, $author$project$Main$quoteDecoder),
		aR: $author$project$Main$quotesApiUrl
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			var quoteRes = msg.a;
			if (!quoteRes.$) {
				var quote = quoteRes.a;
				return _Utils_Tuple2(
					$elm$core$Result$Ok(quote),
					$elm$core$Platform$Cmd$none);
			} else {
				var err = quoteRes.a;
				return _Utils_Tuple2(
					$elm$core$Result$Err(
						'Error getting quote: ' + $author$project$Main$httpErrorToString(err)),
					$elm$core$Platform$Cmd$none);
			}
		}
	});
...
var $author$project$Main$buildTwitterShareUrl = F2(
	function (quote, author) {
		return A3(
			...
			_List_fromArray(
				[
					A2($elm$url$Url$Builder$string, 'text', '\"' + (quote + ('\" - ' + author)))
				]));
	});
...
var $author$project$Main$GetQuote = {$: 0};
...
var $author$project$Main$getQuoteRow = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$id('new-quote')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Get New Quote')
						]))
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$id('quote-box')
			]),
		function () {
			if (model.$ === 1) {
				var err = model.a;
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('col-md text-center')
									]),
								_List_fromArray(
									[
										A2(
						...
						$author$project$Main$getQuoteRow
					]);
			} else {
				var quote = model.a.ad;
				var author = model.a.L;
				return _List_fromArray(
					[
						A2(
						$elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('blockquote text-center')
											]),
										_List_fromArray(
											[
												A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												A2($author$project$Main$buildTwitterShareUrl, quote, author)),
												$elm$html$Html$Attributes$rel('noopener noreferrer'),
												$elm$html$Html$Attributes$target('_blank'),
												$elm$html$Html$Attributes$class('btn btn-primary'),
												$elm$html$Html$Attributes$id('tweet-quote'),
												A2($elm$html$Html$Attributes$attribute, 'role', 'button')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Tweet this quote')
											]))
									]))
							]))
					]);
